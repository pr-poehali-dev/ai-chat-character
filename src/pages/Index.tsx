  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        />
        <div
          className="absolute top-1/3 -right-32 w-80 h-80 rounded-full opacity-8 animate-float delay-300"
          style={{ background: "radial-gradient(circle, #22d3ee, transparent 70%)" }}
        />
        <div
          className="absolute -bottom-20 left-1/3 w-72 h-72 rounded-full opacity-8 animate-float delay-600"
      ...
      <header className="relative z-10 flex items-center justify-between px-6 py-5 border-b border-border/40 backdrop-blur-sm">
        ...
        >
          ...
          <div>
            <div className="font-display text-xl font-semibold tracking-wide text-white leading-none">
              Anima
            </div>
